...
export default function Home() {
  return <div className="mf-home">
    <header className="mf-home-nav"><Brand /><Link href="/city" className="mf-link" data-testid="link-enter-desk">Enter Vantage City <ArrowRight size={14} /></Link></header>
     <section className="mf-home-hero"><div className="mf-hero-copy"><div className="mf-eyebrow">A noir detective challenge</div><h1 className="mf-display">You're smarter than most manipulation. <em>Prove it.</em></h1><p className="mf-lede">MINDFRAME turns 30 biases and fallacies most people never notice into cases you actually solve — so next time someone tries it on you, you catch it in real life, not just in a game.</p><div className="mf-hero-actions"><Link href="/city" className="mf-button" data-testid="button-start-investigating">ENTER THE CITY <ArrowRight /></Link><Link href="/cases" className="mf-button secondary" data-testid="button-browse-cases">Browse case files</Link></div></div>
